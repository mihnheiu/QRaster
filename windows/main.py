...
class QRaster:
    ...
    def create_history_file_buttons(self):
        ...
        btn_undo = tk.Button(hist_frame, text="Undo (Ctrl+Z)", command=self.undo)
        btn_undo.pack(side="left", padx=2)

        btn_redo = tk.Button(hist_frame, text="Redo (Ctrl+Y)", command=self.redo)
